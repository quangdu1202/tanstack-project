  ...
  return (
    <div className="slide-out-wrapper">
      <div className="slide-out-inner">
        ...
        <div className={`slide-out-content no-scrollbar overflow-x-hidden overflow-y-scroll`}>
          {/* Post Media Container */}
          <div className="bg-surface-a50 flex h-full w-full overflow-hidden">
            {/*<div className="post-media-zoom-indicator bg-surface-a10 absolute bottom-1 left-1 z-50 flex items-center justify-center rounded-2xl p-2 text-white opacity-50 hover:opacity-100">*/}
            {/*  <button*/}
            {/*    type={'button'}*/}
            ...
            {/*    <span className="sr-only">Lock/Unlock zoom</span>*/}
